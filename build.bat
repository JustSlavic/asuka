...
REM OpenGL
rem cl %COMMON_CL_FLAGS% %COMMON_FLAGS% %WARNINGS% /I../common /Feopengl_demo ../opengl/opengl.cpp /link /PDB:opengl.pdb %COMMON_LINKER_FLAGS% %COMMON_LIBS% opengl32.lib

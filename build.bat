...
SET COMMON_CL_FLAGS=/Fmwin32_main.map /MTd /nologo /GR- /Oi /Zi /EHa- /W4 /WX /wd4201 /wd4100 /wd4189
SET COMMON_LINKER_FLAGS=/opt:ref
SET COMMON_MY_FLAGS=/DUNITY_BUILD /DASUKA_DEBUG /DASUKA_OS_WINDOWS /I../common /D_CRT_SECURE_NO_WARNINGS
